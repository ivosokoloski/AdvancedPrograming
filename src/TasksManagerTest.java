    ...
    class TaskManager{
        ...
        public void readTasks (InputStream inputStream){
            try (BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(inputStream))) {
                ...
                while ((line=bufferedReader.readLine())!=null){
                    ...
                    if(tasks.get(tasks.size()-1).roknazadaca!=null&&LocalDateTime.parse(tasks.get(tasks.size()-1).roknazadaca).isAfter(LocalDateTime.of(2020,6,2,0,0,0))){
        ...
        void printTasks(OutputStream os, boolean includePriority, boolean includeCategory){
            ...
            if(includeCategory==true){
                tasks.stream().collect(Collectors.groupingBy(Task::getKategorija,TreeMap::new,Collectors.toList())).forEach((kategorija,nasoka)->{
